...
import {fatchAllRecipesRequestBrunch} from '../../services/rest/CategoryRecipes';
...
export default function AllRecipes() {
  ...
  useEffect(()=>{
    dispatch(fatchAllRecipesRequestBrunch())
  },[])

  return(
    [
        <div className="home_title">
          <div className="page_title_recipes"><h2>Brunch</h2></div>
