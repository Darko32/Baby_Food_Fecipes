...
import {fatchAllRecipesRequestLunch} from '../../services/rest/CategoryRecipes';
...
export default function AllRecipes() {
  ...
  useEffect(()=>{
    dispatch(fatchAllRecipesRequestLunch())
  },[])

  return(
    [
        <div className="home_title">
          <div className="page_title_recipes"><h2>Lunch</h2></div>
