...
export const MyRecipes = () => {
    ...
    return(
      ...
      <div className ="my_recipe_title"><h2>My Recipes</h2></div>
      <div className="myprofile-line"><hr></hr></div>
      <div className="button-circle"><Link to={ROUTES.ADD_RECIPE}><button className="button_recipes"><img src={plus} alt="logo"/></button></Link>
    </div>
    </div>
