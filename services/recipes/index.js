...
api.use(jwt({
    ...
    path: [
        ...
        { url: '/api/v1/recipes/a', method: ['GET'] },
        { url: '/api/v1/recipes/breakfast', method: ['GET'] },
        { url: '/api/v1/recipes/brunch', method: ['GET'] },
        { url: '/api/v1/recipes/lunch', method: ['GET'] },
        { url: '/api/v1/recipes/dinner', method: ['GET'] }
    ]
}));
...
api.get('/api/v1/recipes/a', recipes.getAllA);
...
api.get('/api/v1/recipes/breakfast', recipes.getAllRecipesBreakfast);
api.get('/api/v1/recipes/brunch', recipes.getAllRecipesBrunch);
api.get('/api/v1/recipes/lunch', recipes.getAllRecipesLunch);
api.get('/api/v1/recipes/dinner', recipes.getAllRecipesDinner);
api.get('/api/v1/recipes/:id', recipes.getOne);
api.put('/api/v1/recipes/:id/rate', recipes.rateOne);
api.put('/api/v1/recipes/:id/like', recipes.like);
